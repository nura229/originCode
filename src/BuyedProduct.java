...
public BuyedProduct(String uname,String Pname,String bamount,String bname,String price,String address) throws Exception {
   this.username = uname;
...
public void buyproduct(String uname, String pname, String bamount,String bname,String pprice,String shippingaddress) throws Exception {
	...
	if(FoundinSystem2==false) {
		System.out.println("The user name is not available");
	}
	if(FoundinSystem5==false) {
		System.out.println("The store owner name is not available");
	}
	...
	if( FoundinSystem3==true && FoundinSystem4==true &&(FoundinSystem2==true||FoundinSystem5==true)) {
		...
		if (FoundinSystem2 == true) { // law user
		 ...
		 FileUsage.usingBufferedWritter(uname + "|" +pname + "|" + bamount + "|" +bname + "|" + pprice +"|" + shippingaddress,"BuyedProduct.txt");
